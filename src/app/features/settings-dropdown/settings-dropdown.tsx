...
export function SettingsDropdown() {
  ...
  const { lockWallet, currentNetworkKey, hasGeneratedWallet, encryptedSecretKey } = useWallet();
  const createAccount = useCreateAccount();
  const [hasCreatedAccount, setHasCreatedAccount] = useHasCreatedAccount();
  const { setShowNetworks, setShowSettings, showSettings, setShowSignOut } = useDrawers();
